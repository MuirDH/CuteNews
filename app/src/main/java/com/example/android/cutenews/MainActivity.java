...
import static com.example.android.cutenews.QueryUtils.LOG_TAG;
...
public class MainActivity extends AppCompatActivity
    ...
    private static final String URL_TOPIC = "cute";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.i(LOG_TAG, "TEST: Cute News Activity onCreate() called");
